...
final class Thrift {
     ...
     *                            will be generated.
     */
    private Thrift(String executable, String generator, ImmutableSet<File> thriftPath, ImmutableSet<File> thriftFiles, File javaOutputDirectory, Log log) {
    ...
    public int compile() throws CommandLineException {
        ...
        for (File thriftFile : thriftFiles) {
            ...
            if(log != null) {
                log.info("Commandline to execute: " + cl);
            }
            CommandLineCallable callable = CommandLineUtils.executeCommandLineAsCallable(cl, null, output, error, 10);
            final int result = callable.call(); // blocks until process is complete
            if (result != 0) {
                return result;
            }
        }
    ...
    static final class Builder {
         ...
         *                                  not a directory.
         */
        public Builder(String executable, File javaOutputDirectory, Log log) {
            this.executable = checkNotNull(executable, "executable");
        ...
        public Thrift build() {
            ...
            return new Thrift(executable, generator, ImmutableSet.copyOf(thriftPathElements), ImmutableSet.copyOf(thriftFiles), javaOutputDirectory, log);
        }
    }
}
